...
drop user if exists "QUARTZ_USER";

CREATE USER "QUARTZ_USER" PASSWORD 'QUARTZ_PW';

CREATE DATABASE "QUARTZ_DB" WITH OWNER = "QUARTZ_USER"  ENCODING = 'UTF8' TABLESPACE = pg_default;

GRANT ALL ON DATABASE "QUARTZ_DB" to "QUARTZ_USER";

--End--
--Begin Connect--
\connect "QUARTZ_DB" "QUARTZ_USER"
...
ALTER TABLE qrtz5_job_listeners OWNER TO "QUARTZ_USER";
ALTER TABLE qrtz5_trigger_listeners OWNER TO "QUARTZ_USER";
ALTER TABLE qrtz5_fired_triggers OWNER TO "QUARTZ_USER";
ALTER TABLE qrtz5_paused_trigger_grps OWNER TO "QUARTZ_USER";
ALTER TABLE qrtz5_scheduler_state OWNER TO "QUARTZ_USER";
ALTER TABLE qrtz5_locks OWNER TO "QUARTZ_USER";
ALTER TABLE qrtz5_simple_triggers OWNER TO "QUARTZ_USER";
ALTER TABLE qrtz5_cron_triggers OWNER TO "QUARTZ_USER";
ALTER TABLE qrtz5_blob_triggers OWNER TO "QUARTZ_USER";
ALTER TABLE qrtz5_triggers OWNER TO "QUARTZ_USER";
ALTER TABLE qrtz5_job_details OWNER TO "QUARTZ_USER";
ALTER TABLE qrtz5_calendars OWNER TO "QUARTZ_USER";
